...
class lte_Editor(tk.Tk):
    ...
    def setupUI(self):
        ...
        generate_mtr(parameter[0])
        filename = 'Elegant_Process/lte_file/' + parameter[0][2] + '.lte'
        generate_lte(filename, parameter[0])
        ...
        Btn = Btn_def()
        btn1_name = 'Re-load Lte-file:    ' + parameter[0][2] + '.lte'
