...
class ele_Editor(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title('Check and Edit Beam-1:  Elegant-start-command')
    ...
    def setupUI(self):
        ...
        filename = 'Elegant_Process/ele_command/' + parameter[0][3] + '.ele'
        generate_beam_start_ele(filename, parameter[0])
        ...
        Btn = Btn_def()
        btn1_name = 'Re-load ele-file:    ' + parameter[0][3] + '.ele'
