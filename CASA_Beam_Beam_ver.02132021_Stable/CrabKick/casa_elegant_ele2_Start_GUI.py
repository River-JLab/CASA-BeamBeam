...
class ele_Editor(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title('Check and Edit Beam-2:  Elegant-start-command')
    ...
    def setupUI(self):
        ...
        filename = 'Elegant_Process/ele_command/' + parameter[1][3] + '.ele'
        generate_beam_start_ele(filename, parameter[1])
        ...
        Btn = Btn_def()
        btn1_name = 'Re-load ele-file:    ' + parameter[1][3] + '.ele'
