...
! ****************  JLab-CASA Phase output ***********************
    integer :: CASA_i
    character*40 CASA_Phase_in_name
! ****************  JLab-CASA Phase output ***********************
! *****************************************************************************
...
!   ********        CASA Revised part    ****************************************
!   *****************************************************************************
             print*, '  ...............        JLab-CASA BeamID-in = ', myid+1
             CASA_Phase_in_name = 'CASA_Phase_in_'//char(myid+49)//'.casa'

             open(unit=16, file = CASA_Phase_in_name)
             do CASA_i = 1, Nplocal
...
!   *****************************************************************************
  ...
  subroutine run_AccSimulator()
    ...
    print*, "ptOut, nplocal = ", ptOut, nplocal
