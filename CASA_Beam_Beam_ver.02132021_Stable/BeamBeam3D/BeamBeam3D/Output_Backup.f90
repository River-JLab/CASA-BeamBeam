...
! ! ****************  JLab-CASA Phase output ***********************
    ! integer :: CASA_i
    ! character*40 CASA_Phase_out_name
! ! ****************  JLab-CASA Phase output ***********************
...
!   ********        CASA Revised part    ****************************************
!   *****************************************************************************
    print*, '  ...............        JLab-CASA BeamID-out = ', myid+1, ',      Turn number = ', iturn-1
    CASA_Phase_out_name = 'CASA_Phase_out_'//char(myid+49)//'.casa'
...
!   *****************************************************************************
  ...
  subroutine ptclout_Output(Bpts,myid,iturn,idbunch,Nplocal,npOut,nturns,outRate,sampleInd)
    ...
    print*, "RRRRRRRRRRRRRRRRRRRRRR   iturns ..........  nturns ..........", iturn, nturns
