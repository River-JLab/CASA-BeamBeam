...
class BeamParameterEditor(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title("Beam-1:           Check and edit the parameters of Beam-1")
    ...
    def setupUI(self):
        ...
        Btn = Btn_def()
        btn1 = Button(self, text='Re-load Parameters of Beam-1', bg="orange", command=lambda: Btn.load(parameter, contents)).pack(side=LEFT)
        btn2 = Button(self, text='Save and continue', bg="yellow", command=lambda: Btn.save_and_continue(parameter, contents)).pack(side=RIGHT)
